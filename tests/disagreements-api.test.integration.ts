/**
 * Disagreement API Integration Tests
 *
 * Tests the disagreement lifecycle through HTTP handlers:
 * - Create disagreement (+ AI greeting)
 * - Invite partner
 * - Partner join/decline
 * - Message visibility rules
 * - Cross-couple isolation
 *
 * Requires: Docker (PostgreSQL) running + OPENAI_API_KEY in .env
